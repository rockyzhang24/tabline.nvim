...
local colors = { black = 235, red = 196, green = 41, yellow = 229, blue = 63, magenta = 213, cyan = 159 }
...
local function ansi(str, group, default, bold)
  ...
  local color = csi(fg == '' and colors[default] or fg, true) .. (bg == '' and '' or csi(bg, false))
