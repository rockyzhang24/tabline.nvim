--------------------------------------------------------------------------------
-- https://stackoverflow.com/a/38055734/7787852
--------------------------------------------------------------------------------
...
local function round(x)
  return floor(tonumber(x, 16) + 0.5)
end

local function hex2term(rrggbb)
  local r, g, b = rrggbb:match('(%x%x)(%x%x)(%x%x)')
  return nearest_term256_color_index(round(r), round(g), round(b))
end

return { hex2term = hex2term }
